...
xfails = {
    ...
    "/regression/e2e?test_operator/test_051_1:": [(Fail, "Test 51 may fail in dev env due to incorrect github path")],
    # test_clickhouse.py
    ...
    # ],
    # test_keeper.py
    "/regression/e2e?test_keeper/test_*_chk*": [
        (Fail, "need proper ClickHouseKeeperInstallation scale up and scale down implementation"),
    ],
