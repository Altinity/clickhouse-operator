...
xfails = {
    ...
    "/regression/e2e.test_operator/test_041*": [(Fail, "Test 41 sometimes fails due to incorrect certificate")],
    "/regression/e2e.test_operator/test_044*": [(Fail, "Test 44 sometimes fails")],
