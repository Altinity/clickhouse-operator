...
MINIKUBE_VERSION=${MINIKUBE_VERSION:=1.22.0}
...
if ! [ -f "cache/preloaded-images-k8s-v12-v${MINIKUBE_VERSION}-docker-overlay2-amd64.tar.lz4" ]; then
    wget https://storage.googleapis.com/minikube-preloaded-volume-tarballs/preloaded-images-k8s-v12-v${MINIKUBE_VERSION}-docker-overlay2-amd64.tar.lz4 -P ./cache/
fi
