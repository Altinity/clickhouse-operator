...
OPERATOR_VERSION=${OPERATOR_VERSION:=0.23.0}
OPERATOR_VERSION_OLD=${OPERATOR_VERSION_OLD:=0.22.2}
...
CLICKHOUSE_BACKUP_IMAGE="altinity/clickhouse-backup:stable"
...
PROMETHEUS_ALERT_MANAGER_IMAGE=${PROMETHEUS_ALERT_MANAGER_IMAGE:="quay.io/prometheus/alertmanager:v0.26.0"}
