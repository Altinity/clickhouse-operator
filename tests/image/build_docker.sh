...
OPERATOR_VERSION=${OPERATOR_VERSION:=0.17.0}
OPERATOR_VERSION_OLD=${OPERATOR_VERSION_OLD:=0.16.1}
...
CLICKHOUSE_BACKUP_IMAGE="altinity/clickhouse-backup:1.2.0"
...
ZOOKEEPER_IMAGE=${ZOOKEEPER_IMAGE:="zookeeper:3.6.1"}
