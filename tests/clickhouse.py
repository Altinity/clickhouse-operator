...
def clickhouse_query(chi_name, query, with_error=False, host="127.0.0.1", port="9000", user="default", pwd="", ns=test_namespace, timeout=60, advanced_params=''):
...
def clickhouse_query_with_error(chi_name, query, host="127.0.0.1", port="9000", user="default", pwd="", ns=test_namespace, timeout=60, advanced_params=''):
    return clickhouse_query(chi_name, query, True, host, port, user, pwd, ns, timeout, advanced_params)
