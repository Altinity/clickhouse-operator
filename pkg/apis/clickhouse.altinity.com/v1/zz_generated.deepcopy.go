...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChiZookeeperNodes) DeepCopyInto(out *ChiZookeeperNodes) {
	*out = *in
	if in.Nodes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChiZookeeperNodes.
func (in *ChiZookeeperNodes) DeepCopy() *ChiZookeeperNodes {
	if in == nil {
		return nil
	}
	out := new(ChiZookeeperNodes)
	in.DeepCopyInto(out)
	return out
}
