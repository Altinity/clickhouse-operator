...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (zkc *ChiZookeeperConfig) DeepCopyInto(out *ChiZookeeperConfig) {
	*out = *zkc
	if zkc.Nodes != nil {
		in, out := &zkc.Nodes, &out.Nodes
...
func (zkc *ChiZookeeperConfig) DeepCopy() *ChiZookeeperConfig {
	if zkc == nil {
		return nil
	}
	out := new(ChiZookeeperConfig)
	zkc.DeepCopyInto(out)
	return out
}
