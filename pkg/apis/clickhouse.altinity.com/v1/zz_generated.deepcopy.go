...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChiDefaultTemplates) DeepCopyInto(out *ChiDefaultTemplates) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChiDefaultTemplates.
func (in *ChiDefaultTemplates) DeepCopy() *ChiDefaultTemplates {
	if in == nil {
		return nil
	}
	out := new(ChiDefaultTemplates)
	in.DeepCopyInto(out)
	return out
}
