...
func NewOwnerReferencesManager(what OwnerReferencesManagerType) interfaces.IOwnerReferencesManager {
	switch what {
	case OwnerReferencesManagerTypeClickHouse:
		return chiCreator.NewOwnerReferencer()
	case OwnerReferencesManagerTypeKeeper:
		return chkCreator.NewOwnerReferencer()
	}
	panic("unknown OwnerReference manager type")
}
