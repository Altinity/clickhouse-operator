...
func CreateConfigMapCommonName(chi chi) string {
...
func CreateConfigMapCommonUsersName(chi chi) string {
...
func CreateCHIServiceName(chi chi) string {
...
func CreateCHIServiceFQDN(chi chi) string {
...
func CreateClusterServiceName(cluster cluster) string {
	// Name can be generated either from default name pattern,
	// or from personal name pattern provided in ServiceTemplate
...
func CreateShardServiceName(shard shard) string {
	// Name can be generated either from default name pattern,
	// or from personal name pattern provided in ServiceTemplate
...
func CreateShardName(shard shard, index int) string {
	return strconv.Itoa(index)
}

// IsAutoGeneratedShardName checks whether provided name is auto-generated
func IsAutoGeneratedShardName(name string, shard shard, index int) bool {
...
func CreateReplicaName(replica replica, index int) string {
	return strconv.Itoa(index)
}

// IsAutoGeneratedReplicaName checks whether provided name is auto-generated
func IsAutoGeneratedReplicaName(name string, replica replica, index int) bool {
	return name == CreateReplicaName(replica, index)
}

// CreateHostName returns a name of a host
func CreateHostName(host *api.ChiHost, shard shard, shardIndex int, replica replica, replicaIndex int) string {
...
func createPodFQDNsOfCluster(cluster cluster) (fqdns []string) {
...
func createPodFQDNsOfShard(shard shard) (fqdns []string) {
...
func createPodFQDNsOfCHI(chi chi) (fqdns []string) {
...
func CreateFQDNs(obj interface{}, scope interface{}, excludeSelf bool) []string {
	...
	case *api.ChiHost:
		...
		case api.ChiShard:
			return util.RemoveFromArray(self, createPodFQDNsOfShard(any(typed.GetShard()).(shard)))
		case api.Cluster:
			return util.RemoveFromArray(self, createPodFQDNsOfCluster(any(typed.GetCluster()).(cluster)))
		case api.ClickHouseInstallation:
			return util.RemoveFromArray(self, createPodFQDNsOfCHI(any(typed.GetCHI()).(chi)))
		}
	}
	return nil
}
...
func CreatePodHostnameRegexp(chi chi, template string) string {
...
func createPodNamesOfCluster(cluster cluster) (names []string) {
	cluster.WalkHosts(func(host *api.ChiHost) error {
...
func createPodNamesOfShard(shard shard) (names []string) {
	shard.WalkHosts(func(host *api.ChiHost) error {
		names = append(names, CreatePodName(host))
		return nil
	})
...
func createPodNamesOfCHI(chi chi) (names []string) {
	chi.WalkHosts(func(host *api.ChiHost) error {
		names = append(names, CreatePodName(host))
		return nil
	})
...
func CreateClusterAutoSecretName(cluster cluster) string {
	if cluster.GetName() == "" {
		return fmt.Sprintf(
			"%s-auto-secret",
