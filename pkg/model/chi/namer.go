...
func CreateConfigMapCommonName(chi IChi) string {
...
func CreateConfigMapCommonUsersName(chi IChi) string {
...
func CreateCHIServiceName(chi IChi) string {
...
func CreateCHIServiceFQDN(chi IChi) string {
...
func CreateClusterServiceName(cluster ICluster) string {
	// Name can be generated either from default name pattern,
	// or from personal name pattern provided in ServiceTemplate
...
func CreateShardServiceName(shard IShard) string {
	// Name can be generated either from default name pattern,
	// or from personal name pattern provided in ServiceTemplate
...
func CreateShardName(shard IShard, index int) string {
	return strconv.Itoa(index)
}

// IsAutoGeneratedShardName checks whether provided name is auto-generated
func IsAutoGeneratedShardName(name string, shard IShard, index int) bool {
...
func CreateReplicaName(replica IReplica, index int) string {
	return strconv.Itoa(index)
}

// IsAutoGeneratedReplicaName checks whether provided name is auto-generated
func IsAutoGeneratedReplicaName(name string, replica IReplica, index int) bool {
	return name == CreateReplicaName(replica, index)
}

// CreateHostName returns a name of a host
func CreateHostName(host *api.ChiHost, shard IShard, shardIndex int, replica IReplica, replicaIndex int) string {
...
func createPodFQDNsOfCluster(cluster ICluster) (fqdns []string) {
...
func createPodFQDNsOfShard(shard IShard) (fqdns []string) {
...
func createPodFQDNsOfCHI(chi IChi) (fqdns []string) {
...
func CreateFQDNs(obj interface{}, scope interface{}, excludeSelf bool) []string {
	...
	case *api.ChiHost:
		...
		case api.ChiShard:
			return util.RemoveFromArray(self, createPodFQDNsOfShard(any(typed.GetShard()).(IShard)))
		case api.Cluster:
			return util.RemoveFromArray(self, createPodFQDNsOfCluster(any(typed.GetCluster()).(ICluster)))
		case api.ClickHouseInstallation:
			return util.RemoveFromArray(self, createPodFQDNsOfCHI(any(typed.GetCHI()).(IChi)))
		}
	}
	return nil
}
...
func CreatePodHostnameRegexp(chi IChi, template string) string {
...
func createPodNamesOfCluster(cluster ICluster) (names []string) {
	cluster.WalkHosts(func(host *api.ChiHost) error {
...
func createPodNamesOfShard(shard IShard) (names []string) {
	shard.WalkHosts(func(host *api.ChiHost) error {
		names = append(names, CreatePodName(host))
		return nil
	})
...
func createPodNamesOfCHI(chi IChi) (names []string) {
	chi.WalkHosts(func(host *api.ChiHost) error {
		names = append(names, CreatePodName(host))
		return nil
	})
...
func CreateClusterAutoSecretName(cluster ICluster) string {
	if cluster.GetName() == "" {
		return fmt.Sprintf(
			"%s-auto-secret",
