...
func (l *Labeler) getHostScope(host *api.Host, applySupplementaryServiceLabels bool) map[string]string {
	...
	if l.AppendScope {
		...
		labels[LabelCHIScopeIndex] = short.NameLabel(short.CRScopeIndex, host)
		labels[LabelCHIScopeCycleSize] = short.NameLabel(short.CRScopeCycleSize, host)
		labels[LabelCHIScopeCycleIndex] = short.NameLabel(short.CRScopeCycleIndex, host)
		labels[LabelCHIScopeCycleOffset] = short.NameLabel(short.CRScopeCycleOffset, host)
