...
const (
	...
	LabelCRName                       = clickhouse_altinity_com.APIGroupName + "/" + "chi"
	...
	LabelCRScopeIndex            = clickhouse_altinity_com.APIGroupName + "/" + "chiScopeIndex"
	LabelCRScopeCycleSize        = clickhouse_altinity_com.APIGroupName + "/" + "chiScopeCycleSize"
	LabelCRScopeCycleIndex       = clickhouse_altinity_com.APIGroupName + "/" + "chiScopeCycleIndex"
	LabelCRScopeCycleOffset      = clickhouse_altinity_com.APIGroupName + "/" + "chiScopeCycleOffset"
