...
func (in *HostAddress) DeepCopyInto(out *HostAddress) {
	*out = *in
	if in.CHIScope != nil {
		in, out := &in.CHIScope, &out.CHIScope
		*out = new(HostScope)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostScope) DeepCopyInto(out *HostScope) {
	*out = *in
	if in.Cycle != nil {
		in, out := &in.Cycle, &out.Cycle
		*out = new(HostScopeCycle)
		**out = **in
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostScope.
func (in *HostScope) DeepCopy() *HostScope {
	if in == nil {
		return nil
	}
	out := new(HostScope)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostScopeCycle) DeepCopyInto(out *HostScopeCycle) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostScopeCycle.
func (in *HostScopeCycle) DeepCopy() *HostScopeCycle {
	if in == nil {
		return nil
	}
	out := new(HostScopeCycle)
