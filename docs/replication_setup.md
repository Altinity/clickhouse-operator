...
Let's take a look on [example](./examples/04-replication-zookeeper-05-simple-PV.yaml), which creates a cluster with 2 shards and 2 replicas and persistent storage.
