...
import (
	...
	"github.com/schechun/k8s-custom-resource-operator/pkg/client/clientset/versioned/scheme"
...
type ClickhouseV1Interface interface {
	...
	ClickHouseClustersGetter
}

// ClickhouseV1Client is used to interact with features provided by the clickhouse.example.com group.
type ClickhouseV1Client struct {
	restClient rest.Interface
}

func (c *ClickhouseV1Client) ClickHouseClusters(namespace string) ClickHouseClusterInterface {
	return newClickHouseClusters(c, namespace)
}
